  ...
  return (
    <>
      ...
      <button
        ...
        className="md:hidden fixed top-3 left-3 z-50 inline-flex items-center justify-center w-10 h-10 rounded-xl border border-gray-200 bg-white text-[#1e2040] shadow-[0_4px_12px_rgba(15,23,42,0.10)]"
        title={mobileOpen ? "Cerrar menu" : "Abrir menu"}
      >
        {mobileOpen ? <X size={17} /> : <PanelLeftOpen size={17} />}
      </button>
